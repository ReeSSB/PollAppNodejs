...
const users = [
	...
	{ username: "Shashi", password: "password" },
];

const polls = [
	{
		question: "Which is most complete progamming language?",
		options: ["Java", "JavaScript", "Python", "Ruby"],
	},
	{ question: "Which is largest ocean?", options: ["Pacific", "Indian"] },
